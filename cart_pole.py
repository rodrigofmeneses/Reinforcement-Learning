...
#%%
class CartPole():
    def __init__(self, buckets=(1, 1, 6, 12,), n_episodes=1000, n_win_ticks=195, min_alpha=0.1, min_epsilon=0.1, gamma=1.0, ada_divisor=25, max_env_steps=None, monitor=False, render=False):
...
if __name__ == "__main__":
    ...
    # buckets=(1, 1, 6, 12,) # Great Bucket
    solver = CartPole(n_episodes=1000, render=False)
    solver.run()
